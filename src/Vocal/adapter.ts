import { DiscordGatewayAdapterCreator, DiscordGatewayAdapterLibraryMethods } from './Util/adapter';
import { VoiceChannel, Snowflake, Client, Constants, Guild, Events, GatewayDispatchEvents, Status } from 'discord.js';
...
function trackClient(client: Client) {
	...
	client.ws.on(GatewayDispatchEvents.VoiceServerUpdate, (payload: GatewayVoiceStateUpdateDispatchData) => {
